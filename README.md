...
- If new project (not fork):
  - Copy [jurismurabogados.es project files](https://github.com/jurismur/jurismurabogados.es)
...
- `README.md` ⏩ edit baseURL ("jurismurabogados.es") + delete steps bit by bit
- Design
...
- If Cloudflare Pages
  - [Custom domains](https://dash.cloudflare.com/?to=/:account/pages/view/jurismur/domains)
  - `Set up a custom domains`
  - `jurismurabogados.es`
  - `Continue`
  - `Activate domain` (if `Begin DNS transfer` end)
  - Repeat with `www.jurismurabogados.es`
  - ...........................................................
...
- If Netlify Form
  ...
  - [`Netlify ⏩ Site ⏩ Forms ⏩ Form Notifications`](https://app.netlify.com/sites/jurismur/settings/forms#form-notifications) ⏩ `Add notification ⏩ Email notification ⏩ Email to Notify`
    - `Email to notify` = Emails of collaborators that want receive submissions
    - `Custom email subject line` = `Formulario de contacto de jurismurabogados.es`
    - `Save`
  - Submissions: [`Netlify site ⏩ Forms`](https://app.netlify.com/sites/jurismur/forms)
...
1. [Servicios jurismurabogados.es](https://drive.google.com/file/d/1trq28fMfEVwoZOk4ue0tJzAJDZtj64BK) ⏩ `File ⏩ Make a copy` ⏩ Select client directory.
1. Change the info.
